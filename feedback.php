...
?>
    <div class="alert" style="background-color: #50CB93;">
      <p style="font-size: 13px">Successfully send</p>
    </div>
  ...
  ?>
    <div class="alert" style="background-color: #FF2626;">
      <p style="font-size: 13px">Something went wrong</p>
    </div>
...
?>
  ...
  <form method="post" action="feedback.php" autocomplete="off">
    <div class="feedback-container">
      ...
      <input type="radio" id="good" name="experience" style="cursor:pointer" value="Good" />
      <label for="Good" style="cursor:pointer">Good</label><br />
      <input type="radio" id="average" name="experience" style="cursor:pointer" value="Average" />
      <label for="average" style="cursor:pointer">Average</label><br />
      <input type="radio" id="bad" name="experience" style="cursor:pointer" value="Bad" />
      ...
      <input type="radio" id="male" name="gender" style="cursor:pointer" value="Male" />
      <label for="male" style="cursor:pointer">Male</label><br />
      <input type="radio" id="female" name="gender" style="cursor:pointer" value="Female" />
